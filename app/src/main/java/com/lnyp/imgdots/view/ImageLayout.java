...
import com.lnyp.imgdots.activity.PlayActivity;
...
public class ImageLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void addPoints(int width, int height) {
        ...
        for (int i = 0; i < points.size(); i++) {
            ...
            int a = (int) ((getResources().getDisplayMetrics().density * 100) / 2);
            a = 50;
            layoutParams.leftMargin = (int) (width * width_scale) - a;
            layoutParams.topMargin = (int) (height * height_scale) - a;
